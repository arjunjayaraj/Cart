...
<body>
	...
	<div class="row" id="login-box">
		...
		<div class="col s12">
			<ul class="tabs">
				<li class="tab col s6"><a class="active" href="#login">Sign
						In</a></li>
		...
		<div id="register" class="col s12">
			<div>
				<div class="row">
					...
					<form class="col s12" id="registerForm" action="register"
						method="post" commandName="registerForm">
						<p id="error-msg" name="errorMsg"></p>
						<div class="row">
							<div class="input-field col s6">
								<input id="first-name" type="text"
									class="validate alphabets-only" name="fName" required /> <label
									for="first-name">First Name</label>
							</div>
							<div class="input-field col s6">
								<input id="last-name" type="text"
									class="validate alphabets-only" name="lName" required /> <label
						...
						<div class="row">
							<div class="input-field col s6">
								<input id="register-password" type="password" name="password"
									class="validate" required /> <label for="password">Enter
									Password </label>
							</div>
							<div class="input-field col s6">
								<input type="password" name="confirm-password"
									id="confirm-password" class="validate" required /> <label
									for="confirm-password" id="confirm-password-label"
